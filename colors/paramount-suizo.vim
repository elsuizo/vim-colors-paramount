...
call s:h("Type",          {"fg": s:lighter_black, "cterm": "bold", "gui": "bold"})
...
call s:h("Todo",          {"fg": s:dark_red, "gui": "bold", "cterm": "bold"})
...
call s:h("TabLineSel",    {"fg": s:actual_white, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
